...
// exibe as cartas após o cadastro
...
// comparar todas itens das cartas
...
// comparar apenas 1 iten das cartas
void compararUmItem(Trunfo carta1, Trunfo carta2) {
    int populacao1 = carta1.populacao;
    int populacao2 = carta2.populacao;
    ...
    if (populacao1 > populacao2){
        printf("Resultado: Carta 1 (%s) Venceu", carta1.nomeCidade);
    } else if (populacao1 < populacao2) {
        printf("Resultado: Carta 2 (%s) Venceu", carta2.nomeCidade);
    } else {
...
int main() {
    ...
    compararUmItem(cartaTrunfo[0][0], cartaTrunfo[0][1]);
}
